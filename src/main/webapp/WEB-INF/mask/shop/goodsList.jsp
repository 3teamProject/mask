...
<div align="center">
   <h3>
   <c:if test="${cate eq '홈트레이닝'}">Home Training</c:if>
   <c:if test="${cate eq '식품'}">Healthy Diet</c:if>
   <c:if test="${cate eq '홈케어'}">Home Care</c:if>
   </h3> 
</div>
...
<div align="center" style="display:inline-block; float:right; margin-right:50px;">
   <table>
      <tr>
         ...
         <td class="font1"><a href="/muscle/shop/goodsList/${category}/NewItem.do">신상품순</a></td> <td>|</td>
         <td class="font1"><a href="/muscle/shop/goodsList/${category}/favorite.do">인기상품순</a></td> <td>|</td>
         <td class="font1"><a href="/muscle/shop/goodsList/${category}/low.do">낮은가격순</a></td> <td>|</td>
         <td class="font1"><a href="/muscle/shop/goodsList/${category}/high.do">높은가격순</a></td> 
      </tr>
   </table>
</div>
